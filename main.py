...
def main():
    ...
    save(longdividers, "out/long_dividers.svg", "LONGDIVIDERS", PAPER_WIDTH, PAPER_HEIGHT)

    shortdividers = Layer("Root")
    generate_short_dividers(shortdividers)
    add_text(shortdividers, "Short Dividers")
    save(shortdividers, "out/short_dividers.svg", "SHORTDIVIDERS", PAPER_WIDTH, PAPER_HEIGHT)
